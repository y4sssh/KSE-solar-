...
var Pass = class _Pass {
   ...
   */
  constructor(name = "Pass", scene = new import_three.Scene(), camera = new import_three.Camera()) {
    this.name = name;
    this.renderer = null;
    this.scene = scene;
    this.camera = camera;
...
// src/materials/DepthMaskMaterial.js
var DepthMaskMaterial = class extends import_three34.ShaderMaterial {
  /**
  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        depthBuffer0: new import_three34.Uniform(null),
        depthBuffer1: new import_three34.Uniform(null),
        cameraNearFar: new import_three34.Uniform(new import_three34.Vector2(1, 1))
      },
    ...
    this.depthMode = import_three34.LessDepth;
  }
  /**
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer0(buffer, depthPacking = import_three34.BasicDepthPacking) {
   ...
   * @param {DepthPackingStrategies} [depthPacking=BasicDepthPacking] - The depth packing strategy.
   */
  setDepthBuffer1(buffer, depthPacking = import_three34.BasicDepthPacking) {
  ...
  set depthMode(value) {
    let depthTest;
    switch (value) {
      case import_three34.NeverDepth:
        depthTest = "false";
        break;
      case import_three34.AlwaysDepth:
        depthTest = "true";
        break;
      case import_three34.EqualDepth:
        depthTest = "abs(d1 - d0) <= DEPTH_EPSILON";
        break;
      case import_three34.NotEqualDepth:
        depthTest = "abs(d1 - d0) > DEPTH_EPSILON";
        break;
      case import_three34.LessDepth:
        depthTest = "d0 > d1";
        break;
      case import_three34.LessEqualDepth:
        depthTest = "d0 >= d1";
        break;
      case import_three34.GreaterEqualDepth:
        depthTest = "d0 <= d1";
        break;
      case import_three34.GreaterDepth:
      default:
        depthTest = "d0 < d1";
        break;
    }
  ...
  copyCameraSettings(camera) {
    if (camera) {
      ...
      if (camera instanceof import_three34.PerspectiveCamera) {
        this.defines.PERSPECTIVE_CAMERA = "1";
      } else {
        delete this.defines.PERSPECTIVE_CAMERA;
      }
...
// src/materials/GodRaysMaterial.js
var GodRaysMaterial = class extends import_three35.ShaderMaterial {
  /**
  ...
  constructor(lightPosition) {
    super({
      ...
      uniforms: {
        inputBuffer: new import_three35.Uniform(null),
        lightPosition: new import_three35.Uniform(lightPosition),
        density: new import_three35.Uniform(1),
        decay: new import_three35.Uniform(1),
        weight: new import_three35.Uniform(1),
        exposure: new import_three35.Uniform(1),
        clampMax: new import_three35.Uniform(1)
      },
      blending: import_three35.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
...
// src/effects/GodRaysEffect.js
var v = /* @__PURE__ */ new import_three36.Vector3();
var m = /* @__PURE__ */ new import_three36.Matrix4();
var GodRaysEffect = class extends Effect {
  ...
  constructor(camera, lightSource, {
    ...
    super("GodRaysEffect", god_rays_default, {
      ...
      attributes: EffectAttribute.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["map", new import_three36.Uniform(null)]
      ])
    });
    this.camera = camera;
    this._lightSource = lightSource;
    this.lightSource = lightSource;
    this.lightScene = new import_three36.Scene();
    this.screenPosition = new import_three36.Vector2();
    ...
    this.renderTargetLight = new import_three36.WebGLRenderTarget(1, 1);
    this.renderTargetLight.texture.name = "GodRays.Light";
    this.renderTargetLight.depthTexture = new import_three36.DepthTexture();
    this.renderPassLight = new RenderPass(this.lightScene, camera);
    this.renderPassLight.clearPass.overrideClearColor = new import_three36.Color(0);
    this.clearPass = new ClearPass(true, false, false);
    this.clearPass.overrideClearColor = new import_three36.Color(0);
    this.blurPass = new KawaseBlurPass({ kernelSize });
   ...
   */
  setDepthTexture(depthTexture, depthPacking = import_three36.BasicDepthPacking) {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (frameBufferType !== void 0) {
      ...
      if (renderer !== null && renderer.outputColorSpace === import_three36.SRGBColorSpace) {
        this.renderTargetA.texture.colorSpace = import_three36.SRGBColorSpace;
        this.renderTargetB.texture.colorSpace = import_three36.SRGBColorSpace;
        this.renderTargetLight.texture.colorSpace = import_three36.SRGBColorSpace;
      }
    }
  }
};
...
var GridEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
    super("GridEffect", grid_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["scale", new import_three37.Uniform(new import_three37.Vector2())],
        ["lineWidth", new import_three37.Uniform(lineWidth)]
      ])
    });
...
var HueSaturationEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.SRC, hue = 0, saturation = 0 } = {}) {
    super("HueSaturationEffect", hue_saturation_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["hue", new import_three38.Uniform(new import_three38.Vector3())],
        ["saturation", new import_three38.Uniform(saturation)]
      ])
    });
    this.hue = hue;
  }
...
var LensDistortionEffect = class extends Effect {
   ...
   */
  constructor({
    distortion = new import_three39.Vector2(0, 0),
    principalPoint = new import_three39.Vector2(0, 0),
    focalLength = new import_three39.Vector2(1, 1),
    skew = 0
  } = {}) {
    super("LensDistortionEffect", lens_distortion_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["distortion", new import_three39.Uniform(distortion)],
        ["principalPoint", new import_three39.Uniform(principalPoint)],
        ["focalLength", new import_three39.Uniform(focalLength)],
        ["skew", new import_three39.Uniform(skew)]
      ])
    });
  }
  /**
...
var LUT1DEffect = class extends Effect {
  ...
  constructor(lut, { blendFunction = BlendFunction.SRC } = {}) {
    super("LUT1DEffect", lut_1d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([["lut", new import_three40.Uniform(null)]])
    });
    this.lut = lut;
  }
  /**
  ...
  set lut(value) {
    ...
    if (value !== null && (value.type === import_three40.FloatType || value.type === import_three40.HalfFloatType)) {
...
// src/textures/lut/LookupTexture.js
var c = /* @__PURE__ */ new import_three41.Color();
var LookupTexture = class _LookupTexture extends import_three41.Data3DTexture {
  /**
  ...
  constructor(data, size) {
    ...
    this.type = import_three41.FloatType;
    this.format = import_three41.RGBAFormat;
    this.minFilter = import_three41.LinearFilter;
    this.magFilter = import_three41.LinearFilter;
    this.wrapS = import_three41.ClampToEdgeWrapping;
    this.wrapT = import_three41.ClampToEdgeWrapping;
    this.wrapR = import_three41.ClampToEdgeWrapping;
    this.unpackAlignment = 1;
    this.needsUpdate = true;
    this.colorSpace = import_three41.LinearSRGBColorSpace;
    this.domainMin = new import_three41.Vector3(0, 0, 0);
    this.domainMax = new import_three41.Vector3(1, 1, 1);
  }
  /**
  ...
  applyLUT(lut) {
    ...
    } else if (lut.type !== import_three41.FloatType || this.type !== import_three41.FloatType) {
      console.error("Both LUTs must be FloatType textures");
    } else if (lut.format !== import_three41.RGBAFormat || this.format !== import_three41.RGBAFormat) {
   ...
   */
  convertToUint8() {
    if (this.type === import_three41.FloatType) {
      ...
      this.type = import_three41.UnsignedByteType;
      this.needsUpdate = true;
    }
    return this;
  }
   ...
   */
  convertToFloat() {
    if (this.type === import_three41.UnsignedByteType) {
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === import_three41.FloatType) {
      ...
      this.colorSpace = import_three41.SRGBColorSpace;
      this.needsUpdate = true;
    } else {
  ...
  toDataTexture() {
    ...
    const texture = new import_three41.DataTexture(this.image.data, width, height);
    texture.name = this.name;
    texture.type = this.type;
    texture.format = this.format;
    texture.minFilter = import_three41.LinearFilter;
    texture.magFilter = import_three41.LinearFilter;
...
var LUT3DEffect = class extends Effect {
  ...
  constructor(lut, {
    ...
    inputColorSpace = import_three42.SRGBColorSpace
  } = {}) {
    super("LUT3DEffect", lut_3d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["lut", new import_three42.Uniform(null)],
        ["scale", new import_three42.Uniform(new import_three42.Vector3())],
        ["offset", new import_three42.Uniform(new import_three42.Vector3())],
        ["domainMin", new import_three42.Uniform(null)],
        ["domainMax", new import_three42.Uniform(null)]
      ])
    });
  ...
  set lut(value) {
    ...
    if (this.lut !== value) {
      ...
      if (value !== null) {
        ...
        if (value.type === import_three42.FloatType || value.type === import_three42.HalfFloatType) {
          defines.set("LUT_PRECISION_HIGH", "1");
        }
        if (image.width > image.height) {
          defines.set("LUT_STRIP_HORIZONTAL", "1");
        } else if (value instanceof import_three42.Data3DTexture) {
  ...
  updateScaleOffset() {
    ...
    if (lut !== null) {
      ...
      if (this.tetrahedralInterpolation && lut instanceof import_three42.Data3DTexture) {
  ...
  configureTetrahedralInterpolation() {
    const lut = this.lut;
    if (lut !== null) {
      lut.minFilter = import_three42.LinearFilter;
      lut.magFilter = import_three42.LinearFilter;
      if (this.tetrahedralInterpolation) {
        if (lut instanceof import_three42.Data3DTexture) {
          lut.minFilter = import_three42.NearestFilter;
          lut.magFilter = import_three42.NearestFilter;
        } else {
...
// src/materials/DepthComparisonMaterial.js
var DepthComparisonMaterial = class extends import_three43.ShaderMaterial {
  /**
  ...
  constructor(depthTexture = null, camera) {
    super({
      ...
      uniforms: {
        depthBuffer: new import_three43.Uniform(null),
        cameraNear: new import_three43.Uniform(0.3),
        cameraFar: new import_three43.Uniform(1e3)
      },
   ...
   */
  setDepthBuffer(buffer, depthPacking = import_three43.RGBADepthPacking) {
    this.depthBuffer = buffer;
    this.depthPacking = depthPacking;
  }
  /**
  ...
  copyCameraSettings(camera) {
    if (camera) {
      this.uniforms.cameraNear.value = camera.near;
      this.uniforms.cameraFar.value = camera.far;
      if (camera instanceof import_three43.PerspectiveCamera) {
        this.defines.PERSPECTIVE_CAMERA = "1";
      } else {
        delete this.defines.PERSPECTIVE_CAMERA;
      }
...
// src/materials/OutlineMaterial.js
var OutlineMaterial = class extends import_three44.ShaderMaterial {
  /**
   ...
   */
  constructor(texelSize = new import_three44.Vector2()) {
    super({
      name: "OutlineMaterial",
      uniforms: {
        inputBuffer: new import_three44.Uniform(null),
        texelSize: new import_three44.Uniform(new import_three44.Vector2())
      },
      blending: import_three44.NoBlending,
      toneMapped: false,
      depthWrite: false,
      depthTest: false,
...
var DepthPass = class extends Pass {
  ...
  constructor(scene, camera, {
    ...
    super("DepthPass");
    this.needsSwap = false;
    this.renderPass = new RenderPass(scene, camera, new import_three45.MeshDepthMaterial({
      depthPacking: import_three45.RGBADepthPacking
    }));
    ...
    this.renderTarget = renderTarget;
    if (this.renderTarget === void 0) {
      this.renderTarget = new import_three45.WebGLRenderTarget(1, 1, {
        minFilter: import_three45.NearestFilter,
        magFilter: import_three45.NearestFilter
      });
...
var OutlineEffect = class extends Effect {
  ...
  constructor(scene, camera, {
    ...
    super("OutlineEffect", outline_default3, {
      uniforms: /* @__PURE__ */ new Map([
        ["maskTexture", new import_three46.Uniform(null)],
        ["edgeTexture", new import_three46.Uniform(null)],
        ["edgeStrength", new import_three46.Uniform(edgeStrength)],
        ["visibleEdgeColor", new import_three46.Uniform(new import_three46.Color(visibleEdgeColor))],
        ["hiddenEdgeColor", new import_three46.Uniform(new import_three46.Color(hiddenEdgeColor))],
        ["pulse", new import_three46.Uniform(1)],
        ["patternScale", new import_three46.Uniform(patternScale)],
        ["patternTexture", new import_three46.Uniform(null)]
      ])
    });
    ...
    this.scene = scene;
    this.camera = camera;
    this.renderTargetMask = new import_three46.WebGLRenderTarget(1, 1);
    this.renderTargetMask.samples = multisampling;
    this.renderTargetMask.texture.name = "Outline.Mask";
    this.uniforms.get("maskTexture").value = this.renderTargetMask.texture;
    this.renderTargetOutline = new import_three46.WebGLRenderTarget(1, 1, { depthBuffer: false });
    this.renderTargetOutline.texture.name = "Outline.Edges";
    this.uniforms.get("edgeTexture").value = this.renderTargetOutline.texture;
    this.clearPass = new ClearPass();
    this.clearPass.overrideClearColor = new import_three46.Color(0);
    this.clearPass.overrideClearAlpha = 1;
    this.depthPass = new DepthPass(scene, camera);
    this.maskPass = new RenderPass(scene, camera, new DepthComparisonMaterial(this.depthPass.texture, camera));
    const clearPass = this.maskPass.clearPass;
    clearPass.overrideClearColor = new import_three46.Color(16777215);
    clearPass.overrideClearAlpha = 1;
  ...
  set patternTexture(value) {
    if (value !== null) {
      value.wrapS = value.wrapT = import_three46.RepeatWrapping;
   ...
   */
  initialize(renderer, alpha, frameBufferType) {
    this.blurPass.initialize(renderer, alpha, import_three46.UnsignedByteType);
    if (frameBufferType !== void 0) {
...
var PixelationEffect = class extends Effect {
  ...
  constructor(granularity = 30) {
    super("PixelationEffect", pixelation_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["active", new import_three47.Uniform(false)],
        ["d", new import_three47.Uniform(new import_three47.Vector4())]
      ])
    });
...
var RealisticBokehEffect = class extends Effect {
  ...
  constructor({
    ...
    super("RealisticBokehEffect", realistic_bokeh_default, {
      ...
      attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new import_three48.Uniform(focus)],
        ["focalLength", new import_three48.Uniform(focalLength)],
        ["fStop", new import_three48.Uniform(fStop)],
        ["luminanceThreshold", new import_three48.Uniform(luminanceThreshold)],
        ["luminanceGain", new import_three48.Uniform(luminanceGain)],
        ["bias", new import_three48.Uniform(bias)],
        ["fringe", new import_three48.Uniform(fringe)],
        ["maxBlur", new import_three48.Uniform(maxBlur)],
        ["dof", new import_three48.Uniform(null)]
      ])
    });
    this.rings = rings;
  ...
  set manualDoF(value) {
    if (this.manualDoF !== value) {
      if (value) {
        ...
        this.uniforms.get("dof").value = new import_three48.Vector4(0.2, 1, 0.2, 2);
      } else {
...
var ScanlineEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
    super("ScanlineEffect", scanlines_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["count", new import_three49.Uniform(0)],
        ["scrollSpeed", new import_three49.Uniform(0)]
      ])
    });
    this.resolution = new import_three49.Vector2();
    this.d = density;
...
var v2 = /* @__PURE__ */ new import_three50.Vector3();
var ab = /* @__PURE__ */ new import_three50.Vector3();
var ShockWaveEffect = class extends Effect {
   ...
   */
  constructor(camera, position = new import_three50.Vector3(), {
    speed = 2,
    maxRadius = 1,
    waveSize = 0.2,
    amplitude = 0.05
    ...
    super("ShockWaveEffect", shock_wave_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["active", new import_three50.Uniform(false)],
        ["center", new import_three50.Uniform(new import_three50.Vector2(0.5, 0.5))],
        ["cameraDistance", new import_three50.Uniform(1)],
        ["size", new import_three50.Uniform(1)],
        ["radius", new import_three50.Uniform(-waveSize)],
        ["maxRadius", new import_three50.Uniform(maxRadius)],
        ["waveSize", new import_three50.Uniform(waveSize)],
        ["amplitude", new import_three50.Uniform(amplitude)]
      ])
    });
